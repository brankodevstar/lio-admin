                    ...
                    <Widget disableWidgetMenu>
                        <Grid container item xs={12}>
                            <Grid item xs={4}>
                                ...
                                >
                                    <Typography>
                                        There are few position options available
                                        for notifications. You can click any of
                            ...
                            <Grid item xs={4}>
                                ...
                                >
                                    <Typography>
                                        Different types of notifications for
                                        lost of use cases. Custom classes are
                                        also supported.
                                    </Typography>
                            ...
                            <Grid item xs={4}>
                                ...
                                >
                                    <Typography>
                                        Notifications are created with the help
                                        of{" "}
        ...
        show notification
            ...
            `}</SyntaxHighlighter>
                                        <Typography variant="caption">
                                            For more API information refer to

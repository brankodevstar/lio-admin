      ...
      <Dialog open={dialogIndex === 1} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            helperText={
              errors.categoryName.error ? errors.categoryName.helperText : ""
            }
            onBlur={handleValid}
          />
          <TextField
            ...
            helperText={
              errors.description.error ? errors.description.helperText : ""
            }
            onBlur={handleValid}
          />
          <TextField
          ...
          <TextField
            ...
            helperText={
              errors.investors.error ? errors.investors.helperText : ""
            }
            onBlur={handleValid}
          />
          <TextField
            ...
            helperText={
              errors.roundClose.error ? errors.roundClose.helperText : ""
            }
            onBlur={handleValid}
          />
          <TextField
              ...
              <Grid container key={index}>
                ...
                <Grid item xs={2} align="right">
                  <Button
                    ...
                    color="secondary"
                    onClick={() =>
                      removeChildData("overview", "highlights", index)
                    }
                  >
                    -
                  </Button>
            ...
            <Grid container key={index}>
              ...
              <Grid item xs={2} align="right">
                <Button
                  variant="contained"
                  color="secondary"
                  onClick={() => removeChildData("pitchDetails", "", index)}
                >
                  -
                </Button>
              </Grid>
            ...
            <Grid container key={index}>
              ...
              <Grid item xs={2} align="right">
                <Button
                  variant="contained"
                  color="secondary"
                  onClick={() => removeChildData("team", "", index)}
                >
                  -
                </Button>
              </Grid>
            ...
            <Grid container key={index}>
              ...
              <Grid item xs={2} align="right">
                <Button
                  variant="contained"
                  color="secondary"
                  onClick={() => removeChildData("documents", "", index)}
                >
                  -
                </Button>
              </Grid>

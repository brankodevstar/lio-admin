...
const tableHeaders = [
    'No', 'Type', 'Photo', 'Title', 'Category', 'Description', 'Funded', 'Investors', 'Round Close', 'Location', 'Close Day', 'Operation'
];
    ...
    const addHighlight = () => {
        setInvestmentData({
            ...
            overview: {
                ...investmentData.overview,
                highlights: [
                    ...investmentData.overview.highlights,
                    ''
                ]
            }
        })
        ...
        <>
                            ...
                            <TableBody>
                                {investments.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{item.funded}</TableCell>
                                        <TableCell align="center">{item.investors}</TableCell>
                                        <TableCell align="center">{item.roundClose}</TableCell>
                                        <TableCell align="center">{item.location}</TableCell>
                                        <TableCell align="center">{item.closeDay}</TableCell>

                                        <TableCell align="center">
                                            <Button size="small" startIcon={<Update />} onClick={() => { updateInvestment(item) }} />
                                            <Button size="small" startIcon={<Delete />} onClick={() => { deleteInvestment(item) }} />
                                        </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
            ...
            <Dialog open={dialogIndex === 1} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <Typography>Photo {photoRequired && <span className={classes.mandatoryField}>required</span>}
                    </Typography>
                    <ImageUploader setPath={setUploadedPath} filePath={investmentData.imageUrl} />
                    <TextField
                        margin="dense"
                        id="title"
                        name="title"
                    ...
                    <TextField
                        ...
                        helperText={errors.categoryName.error ? errors.categoryName.helperText : ''}
                        onBlur={handleValid}
                    />
                    <TextField
                        margin="dense"
                    ...
                    <TextField
                        ...
                        helperText={errors.funded.error ? errors.funded.helperText : ''}
                        onBlur={handleValid}
                    />
                    <TextField
                        margin="dense"
                        ...
                        helperText={errors.investors.error ? errors.investors.helperText : ''}
                        onBlur={handleValid}
                    />
                    <TextField
                        margin="dense"
                        ...
                        helperText={errors.roundClose.error ? errors.roundClose.helperText : ''}
                        onBlur={handleValid}
                    />
                    <TextField
                        margin="dense"
                    ...
                    <TextField
                        ...
                        helperText={errors.closeDay.error ? errors.closeDay.helperText : ''}
                        onBlur={handleValid}
                    />
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleClose} >Cancel</Button>
                    <Button onClick={handleSave} variant="contained">Next</Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog open={dialogIndex === 2} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    />
                    <Box variant="outlined" className={classes.highlightContainer}>
                        <Button variant="contained" onClick={addHighlight}>Add Highlights</Button>
                        {
                            investmentData.overview.highlights.map((item, index) => (
                                <Grid container key={index}>
                                    ...
                                    <Grid item xs={2} align="right">
                                        <Button variant="contained" color="secondary" onClick={() => removeChildData("overview", "highlights", index)}>-</Button>
                                    </Grid>
                                </Grid>
                            ))
                        }
                    ...
                    <Box className={classes.highlightContainer}>
                        <TextField
                            ...
                            fullWidth
                            variant="standard"
                            value={investmentData.overview.investmentDetails.target}
                        ...
                        <TextField
                            ...
                            fullWidth
                            variant="standard"
                            value={investmentData.overview.investmentDetails.minimum}
                            onChange={handleInvestmentDetails}
                        />
                        <TextField
                            margin="dense"
                            ...
                            fullWidth
                            variant="standard"
                            value={investmentData.overview.investmentDetails.investmentRaised}
                            onChange={handleInvestmentDetails}
                        />
                        <TextField
                            margin="dense"
                            ...
                            fullWidth
                            variant="standard"
                            value={investmentData.overview.investmentDetails.previousRound}
                            onChange={handleInvestmentDetails}
                        />
                        <TextField
                            margin="dense"
                            ...
                            fullWidth
                            variant="standard"
                            value={investmentData.overview.investmentDetails.stage}
                            onChange={handleInvestmentDetails}
                        />
                    </Box>
                </DialogContent>
                            ...
                            <Grid container key={index}>
                                <Grid item xs={10}>
                                    <Box className={classes.highlightContainer}>
                                        ...
                                        <TextField
                                            margin="dense"
                                            name={"pitchDetail-description-" + index}
                                            type="text"
                                            label="description"
                                            fullWidth
                                            variant="standard"
                                ...
                                <Grid item xs={2} align="right">
                                    <Button variant="contained" color="secondary" onClick={() => removeChildData("pitchDetails", "", index)}>-</Button>
                                </Grid>
                            </Grid>
                        ))
                    }
                            ...
                            <Grid container key={index}>
                                <Grid item xs={10}>
                                    <Box className={classes.highlightContainer}>
                                        ...
                                        <ImageUploader setPath={setUploadedFilePath} filePath={item.avatarUrl} parentFieldName="team" index={index} fieldName="avatarUrl" />
                                        <TextField
                                            margin="dense"
                                ...
                                <Grid item xs={2} align="right">
                                    <Button variant="contained" color="secondary" onClick={() => removeChildData("team", "", index)}>-</Button>
                                </Grid>
                            </Grid>
                        ))
                    }
            ...
            <Dialog open={dialogIndex === 5} onClose={handleClose}>
                            ...
                            <Grid container key={index}>
                                <Grid item xs={10}>
                                    <Box className={classes.highlightContainer}>
                                        ...
                                        <ImageUploader fileType="file" setPath={setUploadedFilePath} filePath={item.documentUrl} parentFieldName="documents" index={index} fieldName="documentUrl" />
                                        <TextField
                                            margin="dense"
                                ...
                                <Grid item xs={2} align="right">
                                    <Button variant="contained" color="secondary" onClick={() => removeChildData("documents", "", index)}>-</Button>
                                </Grid>
                            </Grid>
                        ))
                    }
                ...
                <DialogActions>
                    <Button onClick={handleClose} >Cancel</Button>
                    <Button onClick={handleSave} variant="contained">Finish</Button>
                </DialogActions>
            </Dialog>
        </>
    )

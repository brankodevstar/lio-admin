...
export default function BenefitPage() {
  ...
  const handleSave = async () => {
    if (validateBenefitData()) {
      ...
      if (benefitData._id) {
        response = await Action.Benefits.update(benefitData._id, benefitData);
      } else {
              ...
              <TableBody>
                {benefitList.map((benefit, index) => (
                  ...
                  >
                    ...
                    <TableCell align="center">{benefit.discountText}</TableCell>
                    <TableCell align="center">{benefit.rating}</TableCell>
                    <TableCell align="center">{benefit.locationName}</TableCell>
                    <TableCell align="center">{benefit.location}</TableCell>
                    <TableCell align="center">{benefit.distance}</TableCell>
                    <TableCell align="center">{benefit.createdDt}</TableCell>
                    <TableCell align="center">
                      <Button
                        size="small"
                        startIcon={<Update />}
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            helperText={
              errors.locationName.error ? errors.locationName.helperText : ""
            }
            onBlur={handleValid}
          />
          <TextField
